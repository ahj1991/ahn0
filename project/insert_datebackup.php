<?php
    ...
    $userfile_01=$_FILES['upfile'][0];
    $userfile_02=$_FILES['upfile'][1];
    $userfile_03=$_FILES['upfile'][2];
    $userfile_04=$_FILES['upfile'][3];
    $userfile_05=$_FILES['upfile'][4];
    $userfile_06=$_FILES['upfile'][5];
    $userfile_07=$_FILES['upfile'][6];
    $userfile_08=$_FILES['upfile'][7];
    $userfile_09=$_FILES['upfile'][8];
    $userfile_10=$_FILES['upfile'][9];
    ...
    if($mode=="modify"){
        ...
        $sql .=" userfile='$name',is_html='$is_html' where num=$num";
    }
	else
	{
